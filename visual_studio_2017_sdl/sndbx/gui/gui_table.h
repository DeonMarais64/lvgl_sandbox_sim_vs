 ...
 * GLOBAL PROTOTYPES
 **********************/
extern void gui_table_set_cell_styles(lv_obj_t* table, const lv_style_t* bg, const lv_style_t* c1, const lv_style_t* c2, const lv_style_t* c3, const lv_style_t* c4);
...
extern void gui_table_nsvu_set_row_types(lv_obj_t* table, uint8_t row, lv_table_style_t n, lv_table_style_t s, lv_table_style_t v, lv_table_style_t u );
...
#define gui_table_nsv_set_row(t,r,n,s,v)	gui_table_nsvu_set_row(t,r,n,s,v,NULL)
#define gui_table_nsv_set_row_types(t,r,n,s,v)	gui_table_nsvu_set_row_types(t,r,n,s,v,LV_TABLE_STYLE_BG)
