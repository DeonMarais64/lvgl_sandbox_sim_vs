...
static LV_ATTRIBUTE_LARGE_CONST const uint8_t gylph_bitmap[] = {
    ...
    0x0, 0x0, 0xc, 0xff, 0xff, 0xfd, 0xba, 0xcf,
    0xff, 0xff, 0xb0, 0x0, 0x0, 0xaf, 0xff, 0xfd,
    0x40, 0x0, 0x2, 0xcf, 0xff, 0xf9, 0x0, 0x5,
    0xff, 0xff, 0xd1, 0x0, 0x0, 0x0, 0xb, 0xff,
    0xff, 0x30, 0xd, 0xff, 0xff, 0x40, 0x1, 0x77,
    0x10, 0x1, 0xff, 0xff, 0xb0, 0x2f, 0xff, 0xff,
    0xe3, 0x2e, 0xff, 0xd0, 0x0, 0xdf, 0xff, 0xf1,
    0x7f, 0xff, 0xff, 0xff, 0xff, 0xff, 0xa0, 0x0,
    0xdf, 0xff, 0xf5, 0x9f, 0xff, 0xff, 0xff, 0xff,
    0xe5, 0x0, 0x2, 0xff, 0xff, 0xf7, 0xaf, 0xff,
    0xff, 0xff, 0xfe, 0x10, 0x0, 0x1d, 0xff, 0xff,
    0xf9, 0xaf, 0xff, 0xff, 0xff, 0xf6, 0x0, 0x6,
    0xef, 0xff, 0xff, 0xf8, 0x8f, 0xff, 0xff, 0xff,
    0xf4, 0x0, 0x5f, 0xff, 0xff, 0xff, 0xf7, 0x5f,
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
    0xff, 0xf3, 0xf, 0xff, 0xff, 0xff, 0xfc, 0x44,
    0xdf, 0xff, 0xff, 0xff, 0xe0, 0x8, 0xff, 0xff,
    0xff, 0xf2, 0x0, 0x3f, 0xff, 0xff, 0xff, 0x70,
    0x1, 0xef, 0xff, 0xff, 0xf0, 0x0, 0x2f, 0xff,
    0xff, 0xfd, 0x0, 0x0, 0x3f, 0xff, 0xff, 0xf9,
    0x0, 0xaf, 0xff, 0xff, 0xe2, 0x0, 0x0, 0x4,
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 7143, .adv_w = 131, .box_w = 6, .box_h = 7, .ofs_x = 1, .ofs_y = 10},
    {.bitmap_index = 7164, .adv_w = 352, .box_w = 23, .box_h = 23, .ofs_x = -1, .ofs_y = -3},
    {.bitmap_index = 7429, .adv_w = 352, .box_w = 22, .box_h = 17, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 7616, .adv_w = 352, .box_w = 22, .box_h = 20, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 7836, .adv_w = 352, .box_w = 22, .box_h = 17, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 8023, .adv_w = 242, .box_w = 16, .box_h = 16, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 8151, .adv_w = 352, .box_w = 22, .box_h = 23, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 8404, .adv_w = 352, .box_w = 22, .box_h = 23, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 8657, .adv_w = 396, .box_w = 25, .box_h = 20, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 8907, .adv_w = 352, .box_w = 22, .box_h = 23, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 9160, .adv_w = 396, .box_w = 25, .box_h = 17, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 9373, .adv_w = 352, .box_w = 22, .box_h = 23, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 9626, .adv_w = 176, .box_w = 11, .box_h = 18, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 9725, .adv_w = 264, .box_w = 17, .box_h = 18, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 9878, .adv_w = 396, .box_w = 25, .box_h = 22, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 10153, .adv_w = 352, .box_w = 22, .box_h = 17, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 10340, .adv_w = 308, .box_w = 15, .box_h = 21, .ofs_x = 2, .ofs_y = -2},
    {.bitmap_index = 10498, .adv_w = 308, .box_w = 20, .box_h = 24, .ofs_x = 0, .ofs_y = -4},
    {.bitmap_index = 10738, .adv_w = 308, .box_w = 20, .box_h = 20, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 10938, .adv_w = 308, .box_w = 20, .box_h = 20, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 11138, .adv_w = 308, .box_w = 15, .box_h = 21, .ofs_x = 2, .ofs_y = -2},
    {.bitmap_index = 11296, .adv_w = 308, .box_w = 21, .box_h = 20, .ofs_x = -1, .ofs_y = -2},
    {.bitmap_index = 11506, .adv_w = 220, .box_w = 12, .box_h = 20, .ofs_x = 1, .ofs_y = -2},
    {.bitmap_index = 11626, .adv_w = 220, .box_w = 12, .box_h = 20, .ofs_x = 1, .ofs_y = -2},
    {.bitmap_index = 11746, .adv_w = 352, .box_w = 22, .box_h = 22, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 11988, .adv_w = 352, .box_w = 22, .box_h = 22, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 12230, .adv_w = 308, .box_w = 20, .box_h = 20, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 12430, .adv_w = 308, .box_w = 20, .box_h = 5, .ofs_x = 0, .ofs_y = 6},
    {.bitmap_index = 12480, .adv_w = 396, .box_w = 25, .box_h = 17, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 12693, .adv_w = 440, .box_w = 28, .box_h = 23, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 13015, .adv_w = 396, .box_w = 27, .box_h = 23, .ofs_x = -1, .ofs_y = -3},
    {.bitmap_index = 13326, .adv_w = 352, .box_w = 22, .box_h = 21, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 13557, .adv_w = 308, .box_w = 19, .box_h = 12, .ofs_x = 0, .ofs_y = 2},
    {.bitmap_index = 13671, .adv_w = 308, .box_w = 19, .box_h = 12, .ofs_x = 0, .ofs_y = 2},
    {.bitmap_index = 13785, .adv_w = 440, .box_w = 28, .box_h = 18, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 14037, .adv_w = 352, .box_w = 22, .box_h = 17, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 14224, .adv_w = 352, .box_w = 22, .box_h = 23, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 14477, .adv_w = 352, .box_w = 23, .box_h = 23, .ofs_x = -1, .ofs_y = -3},
    {.bitmap_index = 14742, .adv_w = 308, .box_w = 20, .box_h = 20, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 14942, .adv_w = 308, .box_w = 20, .box_h = 23, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 15172, .adv_w = 308, .box_w = 20, .box_h = 20, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 15372, .adv_w = 220, .box_w = 15, .box_h = 23, .ofs_x = -1, .ofs_y = -3},
    {.bitmap_index = 15545, .adv_w = 308, .box_w = 20, .box_h = 23, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 15775, .adv_w = 308, .box_w = 20, .box_h = 23, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 16005, .adv_w = 396, .box_w = 25, .box_h = 17, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 16218, .adv_w = 352, .box_w = 24, .box_h = 23, .ofs_x = -1, .ofs_y = -3},
    {.bitmap_index = 16494, .adv_w = 264, .box_w = 17, .box_h = 23, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 16690, .adv_w = 440, .box_w = 28, .box_h = 21, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 16984, .adv_w = 440, .box_w = 28, .box_h = 15, .ofs_x = 0, .ofs_y = 1},
    {.bitmap_index = 17194, .adv_w = 440, .box_w = 28, .box_h = 15, .ofs_x = 0, .ofs_y = 1},
    {.bitmap_index = 17404, .adv_w = 440, .box_w = 28, .box_h = 15, .ofs_x = 0, .ofs_y = 1},
    {.bitmap_index = 17614, .adv_w = 440, .box_w = 28, .box_h = 15, .ofs_x = 0, .ofs_y = 1},
    {.bitmap_index = 17824, .adv_w = 440, .box_w = 28, .box_h = 15, .ofs_x = 0, .ofs_y = 1},
    {.bitmap_index = 18034, .adv_w = 440, .box_w = 28, .box_h = 18, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 18286, .adv_w = 308, .box_w = 17, .box_h = 23, .ofs_x = 1, .ofs_y = -3},
    {.bitmap_index = 18482, .adv_w = 308, .box_w = 20, .box_h = 23, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 18712, .adv_w = 352, .box_w = 23, .box_h = 23, .ofs_x = -1, .ofs_y = -3},
    {.bitmap_index = 18977, .adv_w = 440, .box_w = 28, .box_h = 17, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 19215, .adv_w = 264, .box_w = 17, .box_h = 23, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 19411, .adv_w = 354, .box_w = 23, .box_h = 14, .ofs_x = 0, .ofs_y = 1}
};
