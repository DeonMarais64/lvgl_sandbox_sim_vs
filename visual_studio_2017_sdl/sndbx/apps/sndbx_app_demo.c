...
#include "../pages/sndbx_pge_lv_ex_widgets.h"
 ...
 *      DEFINES
 *********************/
#define PAGE_NAME "Sandbox App Demo"
...
static const sndbx_pge_t app_pages[] = {
    {.dsc = &sndbx_pge_templ_dsc				,.prms = &pge_prms[0]},
    {.dsc = &sndbx_pge_template_dscs[0]			,.prms = &pge_prms[1]},
    {.dsc = &sndbx_pge_demo_dscs[3]				,.prms = &pge_prms[2]},
    {.dsc = &sndbx_pge_table_dsc				,.prms = &pge_prms[3]},
    {.dsc = &sndbx_pge_lv_ex_widgets_dsc		,.prms = &pge_prms[4]},
    {.dsc = &sndbx_pge_lv_ex_widgets_dsc		,.prms = &pge_prms[5]},
    {.dsc = &sndbx_pge_lv_ex_widgets_dsc		,.prms = &pge_prms[6]},
    {.dsc = &sndbx_pge_lv_app_sysmon_dsc		,.prms = &pge_prms[7]},
};
static const prms_app_pges_t pge_prms[8] = {
    ...
    {.links.left = &app_pages[1],.links.right = &app_pages[3],.self = &sndbx_pge_demo_dscs[3]},
    {.links.left = &app_pages[2],.links.right = &app_pages[4],},
    {.links.left = &app_pages[3],.links.right = &app_pages[5],.index = 0},
    {.links.left = &app_pages[4],.links.right = &app_pages[6],.index = 1},
    {.links.left = &app_pages[5],.links.right = &app_pages[7],.index = 2},
    {.links.left = &app_pages[6],.links.right = NULL,},
};
