...
extern lv_obj_t* gui_btn_contol_create( lv_obj_t* parent, gui_btn_control_prms_t* pPrms );
extern lv_obj_t* gui_btn_create( lv_obj_t* parent, const char * txt, lv_event_cb_t event_cb, U8 id, lv_font_t * font );
