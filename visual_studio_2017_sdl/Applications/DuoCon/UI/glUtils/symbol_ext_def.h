...
#if LV_TXT_ENC == LV_TXT_ENC_ASCII
#define SYMBOL_EXT_QUESTION		"\xf2"
#define SYMBOL_EXT_INFO			"\xf3"
#define SYMBOL_EXT_RIGHT_HAND	"\xf4"
#define SYMBOL_EXT_LEFT_		"\xf5"
#define SYMBOL_EXT_UP_HAND		"\xf6"
#define SYMBOL_EXT_DOWN_HAND	"\xf7"
#define SYMBOL_EXT_PLAY_CIRCLE	"\xf8"
#define SYMBOL_EXT_PAUSE_CIRCLE	"\xf9"
#define SYMBOL_EXT_STOP_CIRCLE	"\xfa"
#define SYMBOL_EXT_DOWN_CIRCLE	"\xfb"
#define SYMBOL_EXT_LEFT_CIRCLE	"\xfc"
#define SYMBOL_EXT_RIGHT_CIRCLE	"\xfd"
#define SYMBOL_EXT_UP_CIRCLE	"\xfe"

#define SYMBOL_EXT_DEGREE_SIGN				"\xb0"

#elif LV_TXT_ENC == LV_TXT_ENC_UTF8

/**
 * To Do: Add others as and when needed, see
...
/* These two are in sandbox font set. */
